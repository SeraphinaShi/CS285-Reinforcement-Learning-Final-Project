...
from cs285.projection.projection import Projection
from cs285.projection.vae import VAE
...
class VAEProjection(Projection):
  ...
  def check_reconstruction(self, sess, environment,
    ...
    for i in range(image_size):
      ...
      imageio.imwrite(org_img_path, org_img)
      imageio.imwrite(reconstr_img_path, reconstr_img)
